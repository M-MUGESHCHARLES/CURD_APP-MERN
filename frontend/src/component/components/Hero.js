    ...
    <div>
      <div className="px-4 py-5 text-center ">
        <h1 className="display-5 fw-bold text-body-emphasis ">
          <span className="Color_text ">C</span>
          <span className="">ompan</span>
          <span className="Color_text ">Y</span>
        </h1>
            ...
            <div className="align-self-center">
              ...
              <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mt-3 mt-lg-4 ">
                <Link to="/Form">
                  <button
                    type="button"
                    className="fs-6 fw-semibold  btn btn-secondary btn-lg px-4 mx-1 mx-lg-3 shadow"
                  >
                    Add Employees
                  </button>
                </Link>
                <Link to="/Details">
                  <button
                    type="button"
                    className="fs-6 fw-semibold btn btn-outline-secondary btn-lg px-4 mx-1 mx-lg-3 shadow"
                  >
                    View Employees
                  </button>
                </Link>
